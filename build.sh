...
build() {
	echo -e "Building..."
	{ cmake --build $CMAKE_BUILD_DIR --config $BUILD_TYPE --verbose; copy_res_directory; } \
	|| { configure && cmake --build $CMAKE_BUILD_DIR --config $BUILD_TYPE --verbose; copy_res_directory; } \
